import { suma, resta, division, multiplicacion, getRandom } from "./numbers";
...
describe("Probando funciones matematicas", () => {
  ...
  test("Probando la funcion getRandom", () => {
    expect(getRandom(5, 10)).toBeGreaterThanOrEqual(5);
    expect(getRandom(5, 10)).toBeLessThanOrEqual(10);
  });
});
